...
<form action="${basePath}/product/edit.do" method="post" id="product" name="product">
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>&nbsp;</label><input  onclick="getData('${basePath}/product/approve.do?id=${product.id}&status=0','','workspace');" type="button" class="btn" value="回复"/>
                <label>&nbsp;</label><input  onclick="getData('${basePath}/product/approve.do?id=${product.id}&status=1','','workspace');" type="button" class="btn" value="收藏"/>
            </li>
        </ul>
    </div>
</form>
