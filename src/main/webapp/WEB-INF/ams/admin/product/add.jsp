...
<form action="${basePath}/product/add.do" method="post" id="product" name="product">
  ...
  <div class="formbody">
    ...
    <ul class="forminfo">
      ...
      <li><label>收信人</label><input name="name" id="name" type="text" value="" class="dfinput" /><i style="color: red;"></i></li>
      <li><label>消息内容<b>*</b></label>
          <textarea id="content" name="content" cols="" rows="" class="textinput"></textarea><i style="color: red;"></i>
      </li>
      <li><label>&nbsp;</label><input onclick="sendMessage();" type="button" class="btn" value="提交"/></li>
    </ul>
  </div>
</form>
