                ...
                <TR>
                    <TD>
                        <TABLE width="100%" align="center" border="0" cellspacing="0"
                            ...
                            <TBODY>
                            <TR>
                                <TD width="450" class="border" valign="top"
                                                    ...
                                                    <TR>
                                                        <TD>
                                                            <DIV class="tags_kjdt_title">
                                                                <UL>
                                                                    <LI class="menuhover" onmouseover="tags(1,5,'tags_kjdt',0)">已发布
                                                                    </LI>
                                                                    <LI onmouseover="tags(2,5,'tags_kjdt',0)">申报中
                                                                    </LI>
                                                                    <LI onmouseover="tags(2,5,'tags_kjdt',0)">竞标中
                                                                    </LI>
                                                                    <LI onmouseover="tags(2,5,'tags_kjdt',0)">实施中
                                                                    </LI>
                                                                </UL>
                                                            </DIV>
                                                            <DIV class="tags_kjdt_con" style="display: block;">
                                                                <UL>
                                                            ...
                                                            <DIV class="tags_kjdt_con" style="display: none;">
                                                                <UL>
                                                            ...
                                                            <DIV class="tags_kjdt_title">
                                                                <UL>
                                                                    <LI class="menuhover" id="tags_kjdt_title1"
                                                                        onmouseover="tags(1,5,'tags_kjdt',0)">交易中
                                                                    </LI>
                                                                    <LI id="tags_kjdt_title2"
                                                                        onmouseover="tags(2,5,'tags_kjdt',0)">已完成
                                                                    </LI>
                                                                </UL>
                                                            </DIV>
                ...
                <TR>
                    <TD vAlign=top width=699>
                        <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center
                            ...
                            <TR>
                                <TD class=border
                                    ...
                                    height=148 vAlign=top width=677>
                                    <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
                                        <TBODY>
                                        <TR>
                                            <TD>
                        ...
                        <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center
                            ...
                            <TBODY>
                            <TR>
                                <TD class=title_left><SPAN>科技咨询服务</SPAN></TD>
                            </TR>
                            <TR>
                                <TD class=border
                                    style="PADDING-LEFT: 20px; BORDER-TOP-WIDTH: 0px"
                                    ...
                                    <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center
                                        ...
                                        <TR>
                                            <TD class=title_right
                                                align=center><SPAN>系统入口</SPAN></TD>
                                        </TR>
                                        <TR>
                                            <TD
